...
//        let images = [UIImage(named: "logo_1"),UIImage(named: "logo_2"),UIImage(named: "logo_3"),UIImage(named: "logo_4"),UIImage(named: "logo_5")]
        
        setBillboardImages(images as! [UIImage])
